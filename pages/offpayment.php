...
<body>
	...
	<!-- Menu -->
		...
		<div class="row mt-3">
			<div class="col-sm-4 bg-primary py-2"> Total Products: <?php echo $_SESSION['cart_no'];?></div>
			<div class="col-sm-4 bg-light  py-2"> Total Quantity: <?php echo $_SESSION['q'];?></div>
			<div class="col-sm-4 bg-primary  py-2"> Total (<small>vat included</small>): $<?php echo $payment;?></div>
			
		</div>
	 <div class="mt-5 text-center "><a href="offpayment.php?cus_id=<?php Session::remain('log_id');?>" class="font-italic font-weight-bold btn btn-dark w-25 rounded-circle">Order Now</a></div>
	 <div class="mt-5 text-center "><a href="payments.php?total=<?php echo $payment; ?>" class="font-italic font-weight-bold btn btn-warning text-dark w-25 rounded">Back</a></div>
